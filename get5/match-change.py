...
from wtforms import (
    ...
    StringField, RadioField, BooleanField,
...
class MatchForm(Form):
    server_id = SelectField('Select server', coerce=int,
    ...
    has_knife = BooleanField('Play knife round',
			     default=True)
        ...
        if form.validate():
            ...
            if server_avaliable:
                ...
                match = Match.create(
                    ...
                    form.data['veto_mappool'], form.data['server_id'], form.data['has_knife'])
